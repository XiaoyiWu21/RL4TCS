...
from helper import SaveVecNormalizeCallback, lrsched, TensorboardCallback, make_env, log_hyperparameters, create_directories, configure_hyperparameters
...
if __name__ == "__main__":
    ...
    save_dir = f"./results/RL_{config['supply_model']}_{config['toll_type']}/{formatted_time}_{config['array_task_id']}"
